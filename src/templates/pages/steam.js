        ...
        ${steam.topSellers.map((game, i) => `
          <div class="steam-table-row">
            ...
            <div class="steam-col-game">
              <img class="steam-img" src="${game.img}" alt="${game.name}" loading="lazy" decoding="async" data-img-fallback="hide-show-next" data-img-fallback-show-next="1" data-img-fallback-show-display="flex">
	          ...
	          '<div class="steam-table">' +
	            ...
	            list.map((game, i) => (
	              '<div class="steam-table-row">' +
	                ...
	                '</div>' +
	                '<div class="steam-col-game">' +
	                  '<img class="steam-img" src="' + escapeHtml(game?.img || '') + '" alt="' + escapeHtml(game?.name || '') + '" loading="lazy" decoding="async" data-img-fallback="hide-show-next" data-img-fallback-show-next="1" data-img-fallback-show-display="flex">' +
