...
function renderMobileOnlyHomeAd(slotId) {
  ...
  <style>
    .${cardClass} { display:flex !important; width:100% !important; max-width:320px !important; min-height:100px !important; align-items:center; justify-content:center; margin:0 auto !important; }
    .${styleId} { display:block !important; width:320px !important; height:100px !important; margin:0 auto; }
    @media (min-width: 769px) {
      .${cardClass}, .${styleId} { display:none !important; height:0 !important; min-height:0 !important; max-height:0 !important; margin:0 !important; }
    }
  </style>
  <ins class="adsbygoogle ${styleId}"
