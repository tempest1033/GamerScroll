const { prefetchUrl } = require('../runtime/navigation-prefetch');
...
function buildServiceWorker({ version, precache }) {
  return `(${serviceWorkerRuntime.toString()})(${JSON.stringify({ version, precache })}, ${prefetchUrl.toString()});`;
}
