...
- 핵심 이슈 1개만 선정 (두 주제 결합 금지)
- 콤마/그리고/및/슬래시로 두 이슈 연결 금지
- e스포츠는 대형 국제대회/리그 구조 변경/정책급 이슈일 때만 헤드라인 허용 (그 외는 issues로)
- 문장형 금지 (~요, ~어요 어미 사용 금지)
- 추상적 표현 금지 (구체적인 게임명/회사명/숫자 사용)
- 좋은 예: "GTA6 가격 100달러 논란 확산"
- 좋은 예: "메이플 키우기 양대 마켓 1위 등극"
...
function buildWeeklyMetricsBlacklistSummary(prevWeekInsights) {
  ...
  return `\n\n## 🚫 metrics 블랙리스트 (최근 3주 내 언급된 게임 - 절대 재사용 금지):\n${[...gameNames].join(', ')}\n`;
}
