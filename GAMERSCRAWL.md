...
| **본문** | 섹션당 4-5문장 |
| **소제목** | 섹션마다 heading 사용 |
| **이미지** | 섹션마다 1개, 소제목(heading) 바로 다음에 배치, **썸네일과 본문 이미지 중복 금지**, **구글 이미지 서치 최우선** |
| **광고** | 본문 중간에 2-3개 배치 |
...
| **relatedArticles** | (선택) 관련 위키 slug 배열, 자동 생성 없음 | `["unity-engine", "unreal-engine"]` |
...
| **본문** | 섹션당 4-5문장 |
| **소제목** | 섹션마다 heading 사용 |
| **이미지** | 필요 시 섹션당 1개, **썸네일과 본문 이미지 중복 금지**, **구글 이미지 서치 최우선** |
| **문체** | 설명형, 간결하고 직관적으로 |
